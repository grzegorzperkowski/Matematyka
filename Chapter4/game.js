(() => {
  ...
  function rectangleQuestions() {
    ...
    const trueFalse = ["prawda", "fałsz"];
    const yesNo = ["tak", "nie"];
    return [
      choice("fałsz", trueFalse, { label: "Prostokąty", prompt: "Prawda czy fałsz? Każdy prostokąt jest kwadratem.", hint: "Kwadrat musi mieć cztery równe boki. Czy każdy prostokąt spełnia ten dodatkowy warunek?", explanation: "Fałsz. Prostokąt może mieć dwa dłuższe i dwa krótsze boki, więc nie każdy prostokąt jest kwadratem.", visual: geometry("rectangle", { width, height, showDimensions: true }, `${width} ≠ ${height}, więc ten prostokąt nie jest kwadratem.`) }),
      choice("prawda", trueFalse, { label: "Kwadraty", prompt: "Prawda czy fałsz? Każdy kwadrat jest prostokątem.", hint: "Sprawdź, czy kwadrat ma cztery kąty proste, czyli spełnia definicję prostokąta.", explanation: "Prawda. Kwadrat ma cztery kąty proste, więc jest szczególnym prostokątem.", visual: geometry("rectangle", { width: squareSide, height: squareSide, square: true, rightMarks: true }, "Kwadrat ma cztery kąty proste.") }),
      choice("prawda", trueFalse, { label: "Boki prostokąta", prompt: "Prawda czy fałsz? Każdy prostokąt ma dwie pary boków równoległych.", hint: "Porównaj górny bok z dolnym oraz lewy z prawym.", explanation: "Prawda. W prostokącie każda para przeciwległych boków jest równoległa.", visual: geometry("rectangle", { width, height, markOpposites: true }, "Przeciwległe boki tworzą dwie pary boków równoległych.") }),
      choice("fałsz", trueFalse, { label: "Czworokąty", prompt: "Prawda czy fałsz? Każdy czworokąt o bokach równej długości to kwadrat.", hint: "Równe boki nie wystarczą. Kwadrat musi mieć także cztery kąty proste.", explanation: "Fałsz. Romb ma cztery boki równej długości, ale nie musi mieć kątów prostych, więc nie każdy romb jest kwadratem.", visual: geometry("polygon", { sides: 4, variant: "rhombus", markEqualSides: true }, "Romb ma cztery równe boki, lecz jego kąty nie muszą być proste.") }),
      choice("fałsz", trueFalse, { label: "Czworokąty", prompt: "Prawda czy fałsz? Każdy czworokąt o jednakowych kątach to kwadrat.", hint: "Cztery jednakowe kąty w czworokącie są proste. Czy to wystarcza, by wszystkie boki były równe?", explanation: "Fałsz. Prostokąt ma cztery jednakowe kąty proste, ale może mieć boki dwóch różnych długości, więc nie musi być kwadratem.", visual: geometry("rectangle", { width, height, rightMarks: true, showDimensions: true }, "Ten prostokąt ma cztery jednakowe kąty, ale różne długości sąsiednich boków.") }),
