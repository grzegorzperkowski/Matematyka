(() => {
  ...
  function showUpdate(registration) {
    ...
    notice.style.cssText = "position:fixed;z-index:9999;right:1rem;bottom:1rem;display:flex;gap:.75rem;align-items:center;padding:.85rem 1rem;border-radius:.75rem;color:#fff;background:#28252f;box-shadow:0 8px 30px #0005;font:700 14px/1.3 system-ui";
    const text = document.createElement("span"); text.textContent = "Dostępna aktualizacja";
    const button = document.createElement("button"); button.type = "button"; button.textContent = "Wczytaj"; button.style.cssText = "border:0;border-radius:.5rem;padding:.55rem .75rem;font:inherit;cursor:pointer";
